window.onload = function () {
  ...
  var selectColorContainer = document.getElementsByClassName("color");
  let colorExternal = "#00FFAB";

  for (let index = 0; index < selectColorContainer.length; index++) {
    selectColorContainer[index].addEventListener('click', () => {
      colorExternal = selectColorContainer[index].style.backgroundColor;
    })
